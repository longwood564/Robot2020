...
/**
 * This class provides general constants relating to the laws of physics, the
 * measurements of the field, and the measurements of the robot.
 * 
...
public final class Constants {
     ...
     * </ul>
     */
    private static final double kVertDistanceFloorToHoop = 98.25 / kInchesPerMeter;
    /**
     ...
     * </ul>
     */
    public static final double kHorDistanceHexagonToHoop = 29.25 / kInchesPerMeter;
     ...
     * equation.
     */
    public static final double kProjectedHorDistanceToApex = (Math.pow(kInitialVelocityBall, 2)
            * Math.sin(kLauncherAngle) * Math.cos(kLauncherAngle)) / kAccelDueToGravity;
}
